...
class Box():
	...
	def add_api(self):
		#App key and secret
		CLIENT_ID = '607bc9m4iiuqthnfoorcqh6uk5x6p0h5'
		CLIENT_SECRET = 'LiYcr2AFMho39G2sszhwcUu2B9Q00pSb'
	...
	def upload_file(self, client, filePath):
		...
		a_file = app_folder.upload(filePath, file_name=fileName)
		fileName = os.path.basename("{}.key".format(filePath))
		a_file = key_folder.upload(filePath, file_name=fileName)
